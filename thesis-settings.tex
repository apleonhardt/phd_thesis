...
\newcommand{\myTitle}{Circuits and algorithms for \textit{Drosophila} ON and OFF motion vision in natural environments}
\newcommand{\myGroup}{Graduate School of Systemic Neurosciences \\ Ludwig-Maximilians-Universität \\ Munich}
\newcommand{\mySubTitle}{Dissertation \\ \bigskip {\myGroup}}
\newcommand{\myUrl}{\url{http://neuro.mpg.de}}
\newcommand{\myEmail}{leonhardt@neuro.mpg.de}
\newcommand{\myTime}{April 2017}
