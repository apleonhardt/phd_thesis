...
\newcommand{\myTitle}{Circuits and algorithms for motion estimation in natural visual environments}
\newcommand{\mySubTitle}{Dissertation}
\newcommand{\myLocation}{Munich}
\newcommand{\myGroup}{Graduate School of Systemic Neuroscience, \\ LMU Munich}
