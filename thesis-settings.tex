...
\newcommand{\myTitle}{On the relationship between motion detection circuits and natural environments in \textit{Drosophila melanogaster}}
...
\newcommand{\mySubTitle}{Dissertation \\ {\myGroup}}
